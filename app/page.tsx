...
const images = Array.from({ length: 20 }, (_, i) => ({
  width: 200,
  height: 200,
  src: i == 0 ? 'https://images.unsplash.com/photo-1712698396006-1996dc7cb2cc?q=80&w=2701&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D' : `${src}?random=${i}`,
}));
