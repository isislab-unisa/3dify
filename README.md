...
5. [Run the Application Locally](#run-the-application-locally)
   1. [Prerequisites](#prerequisites)
      1. [Common](#common)
      2. [Windows and MacOS](#windows-and-macos)
      3. [Linux](#linux)
   3. [Launch](#launch)
...
#### Windows and MacOS
For executing on Windows and MacOS Systems it is necessary to install beforehand **Docker Desktop** at the following [link](https://www.docker.com/products/docker-desktop/).
